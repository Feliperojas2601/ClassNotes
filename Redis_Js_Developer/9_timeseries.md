...
- **Notas:**
  - Estructura de datos, comandos con prefix TS. Configurable un retention time de datos, memoria reservada (4096KB por defecto). Comandos tipicos como range, add, etc.
  - Compuesta por tuplas, timestamp + medida.
  - Es un módulo que debe cargarse a Redis y en redis añadir al cliente los comandos con redis.addCommand('ts.add')
- **Código:**
  ```javascript
